...
class LanguageAnalyzer:
    ...
    def analyze_text_from_image(self):
        ...
        for entity in entities:
            if entity.entity_type.name == EntityType.EVENT.name:
                entity_name_type[EntityType.EVENT].append(entity.name)
            if entity.entity_type.name == EntityType.PERSON.name:
                entity_name_type[EntityType.PERSON].append(entity.name)
            if entity.entity_type.name == EntityType.LOCATION.name:
                entity_name_type[EntityType.LOCATION].append(entity.name)
            if entity.entity_type.name == EntityType.ORGANIZATION.name:
